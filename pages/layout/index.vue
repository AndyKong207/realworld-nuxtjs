      ...
      <div class="container">
        ...
        <ul class="nav navbar-nav pull-xs-right">
          ...
          <template v-if="user">
            ...
            <li class="nav-item">
              <nuxt-link class="nav-link" to="/settings"> <i class="ion-gear-nuxt-link"></i>&nbsp;Settings </nuxt-link>
            </li>
            <li class="nav-item">
    ...
    <footer>
      <div class="container">
        ...
        <span class="attribution">
          An interactive learning project from <nuxt-link to="https://thinkster.io">Thinkster</nuxt-link>. Code &amp;
